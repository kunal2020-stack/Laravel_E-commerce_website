      ...
      <div class="row">
        <div class="col-md-12">        
          <div class="row">
            ...
            <a href="#"><img src="{{asset('front_assets/img/fashion-banner.png')}}" alt="fashion banner img"></a>
          </div>
          </div>
        </div>
      </div>
          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <P> you can get your money back for any purchase made within the past 30 days. Users can request a refund of their full payment in just a few steps.</P>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
